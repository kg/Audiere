...
extern MPLAYER *Player_Create(const UNIMOD *mf, uint flags);
extern MPLAYER *Player_InitSong(const UNIMOD *mf, MD_VOICESET *owner, uint flags, uint maxvoices);
...
extern void     Player_Cleaner(MPLAYER *ps);
extern void     Player_WipeVoices(MPLAYER *ps);

extern BOOL     Player_SetLoopStatus(MPLAYER *ps, BOOL loop, int loopcount);
...
extern int      Player_GetVolume(MPLAYER *ps);
extern void     Player_SetVolume(MPLAYER *mp, int volume);
extern void     Player_VolumeFade(MPLAYER *ps, int startvol, int destvol, long duration);
extern void     Player_QuickFade(MPLAYER *ps, int start, int dest, int speed);
extern void     Player_VolumeFadeEx(MPLAYER *ps, int startvol, int destvol, long starttime, int whence, long duration);
...
extern void __cdecl Player_Mute(MPLAYER *mp, uint arg1, ...);
extern void __cdecl Player_Unmute(MPLAYER *mp, uint arg1, ...);
extern void __cdecl Player_ToggleMute(MPLAYER *mp, uint arg1, ...);
...
extern void Player_PredictSongLength(MPLAYER *ps);
extern uint Player_BuildQuickLookups(MPLAYER *ps);
extern void Player_SetPosTime(MPLAYER *ps, long time);
extern void Player_PreProcessRow(MPLAYER *ps, MPLAYER *destps);
extern void Player_Restore(MPLAYER *ps, uint stateidx);
