...
// =====================================================================================
    static BOOL AllocSubsection(MMCONFIG *conf, const CHAR *str, uint line)
// =====================================================================================
...
// indexing of the sub-section indexes.  Not to be called by the user!
{
    ...
    conf              = (MMCONFIG *)_mm_calloc(allochandle, 1,sizeof(MMCONFIG));
...

{
    ...
    if((fp=_mm_fopen(fname,"r+b")) == NULL)
    {
        // file not found.  create it, so we can rebuild it if need be!

        _mmlogd("mmconfig > Configuration file not found. Creating new one...");
        if((fp = _mm_fopen(fname,"wb")) == NULL) return NULL;
        _mm_fclose(fp);
        fp = _mm_fopen(fname,"r+b");
    }
...
// =====================================================================================
    void _mmcfg_enable_autofix(MMCONFIG *conf, uint buflen)
// =====================================================================================
...
// =====================================================================================
    BOOL _mmcfg_reqarray_string(MMCONFIG *conf, const CHAR *var, uint nent, CHAR *val[])
// =====================================================================================
{
    uint    lpos,cpos,vpos;
    CHAR   *line;
...
// =====================================================================================
    static BOOL AllocWork2(MMCONFIG *conf, uint count)
// =====================================================================================
...
// =====================================================================================
    int _mmcfg_reqarray_boolean(MMCONFIG *conf, const CHAR *var, uint nent, BOOL *val)
// =====================================================================================
...
// =====================================================================================
    int _mmcfg_reqarray_enum(MMCONFIG *conf, const CHAR *var, const CHAR **enu, uint nent, int *val)
// =====================================================================================
...
// =====================================================================================
    void _mmcfg_insert_subsection(MMCONFIG *conf, const CHAR *var)
// =====================================================================================
...
// =====================================================================================
    void _mmcfg_insert(MMCONFIG *conf, int line, const CHAR *var, const CHAR *val)
// =====================================================================================
...
// =====================================================================================
    void _mmcfg_insert_array(MMCONFIG *conf, int line, const CHAR *var, uint cnt, const CHAR **val)
// =====================================================================================
...
// =====================================================================================
    void _mmcfg_reconstruct(MMCONFIG *conf, int line, const CHAR *var, const CHAR *val)
// =====================================================================================
...
// =====================================================================================
    void _mmcfg_reconstruct_array(MMCONFIG *conf, int line, const CHAR *var, uint cnt, const CHAR **val)
// =====================================================================================
// Fixes errors in a configuration file and markes the file for saving when before it is
// closed - creating a backup file if first modification for the current session is being
// made.
...
// =====================================================================================
    void _mmcfg_reassign_string(MMCONFIG *conf, const CHAR *var, const CHAR *val)
// =====================================================================================
// Reassigns a value to an already existing variable.  Maintains the user's formatting.
{
    ...
    _mm_free(conf->allochandle, line);  conf->line[lpos]=strdup(conf->work);
}


// =====================================================================================
    void _mmcfg_reassign_integer(MMCONFIG *conf, const CHAR *var, int val)
// =====================================================================================
{
    CHAR    work[MMCONF_MAXNAMELEN+1];
...
// =====================================================================================
    void _mmcfg_reassign_boolean(MMCONFIG *conf, const CHAR *var, BOOL val)
// =====================================================================================
{
    CHAR    work[MMCONF_MAXNAMELEN+1];
...
// =====================================================================================
    void _mmcfg_reassign_enum(MMCONFIG *conf, const CHAR *var, const CHAR **enu, int val)
// =====================================================================================
{
    CHAR    work[MMCONF_MAXNAMELEN+1];
...
// =====================================================================================
    void _mmcfg_resarray_string(MMCONFIG *conf, const CHAR *var, uint nent, CHAR *val[])
// =====================================================================================
// Reassigns a value to an already existing variable.  Maintains the user's formatting
// as much as possible...
{
...
// =====================================================================================
    void _mmcfg_resarray_enum(MMCONFIG *conf, const CHAR *var, const CHAR **enu, uint nent, int val[])
// =====================================================================================
{
    uint   cnt;
