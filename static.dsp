...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "acoustique" /D "NDEBUG" /D "_LIB" /D for="if (0) ; else for" /D "WIN32" /D "_MBCS" /D "WIN32_LEAN_AND_MEAN" /D "STRICT" /FD /c
# SUBTRACT CPP /YX
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "acoustique" /D "_DEBUG" /D "_LIB" /D for="if (0) ; else for" /D "WIN32" /D "_MBCS" /D "WIN32_LEAN_AND_MEAN" /D "STRICT" /FD /GZ /c
# SUBTRACT CPP /YX
